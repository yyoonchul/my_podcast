        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-6 md:mb-12">
            ...
            <p className="text-sm md:text-lg text-gray-600">
              {podcastType === 'news' ? (
                <>
                  Choose the topics that matter to you, <br />
                  and we'll deliver daily news episodes curated just for your interests. <br />
                  Stay informed effortlessly.
                </>
              ) : (
                <>
                  Select your profession, and we'll curate daily podcasts with industry news, <br />
